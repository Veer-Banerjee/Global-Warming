...
var crafts = ["craft1","craft2","craft3","craft4"];
...
function updatePrice() {
    ...
    var book3CostInCents = book3.quantity * book3.dollars * 100 + book3.quantity * book3.cents;
    var book4CostInCents = book4.quantity * book4.dollars * 100 + book4.quantity * book4.cents;
    var book5CostInCents = book5.quantity * book5.dollars * 100 + book5.quantity * book5.cents;
    var book6CostInCents = book6.quantity * book6.dollars * 100 + book6.quantity * book6.cents;
    var game1CostInCents = game1.quantity * game1.dollars * 100 + game1.quantity * game1.cents;
    var game2CostInCents = game2.quantity * game2.dollars * 100 + game2.quantity * game2.cents;
    var game3CostInCents = game3.quantity * game3.dollars * 100 + game3.quantity * game3.cents;
    var game4CostInCents = game4.quantity * game4.dollars * 100 + game4.quantity * game4.cents;
    var craft1CostInCents = craft1.quantity * craft1.dollars * 100 + craft1.quantity * craft1.cents;
    var craft2CostInCents = craft2.quantity * craft2.dollars * 100 + craft2.quantity * craft2.cents;
    var craft3CostInCents = craft3.quantity * craft3.dollars * 100 + craft3.quantity * craft3.cents;
    var craft4CostInCents = craft4.quantity * craft4.dollars * 100 + craft4.quantity * craft4.cents;
    totalPriceInCents =
        book1CostInCents +
        book2CostInCents +
        book3CostInCents +
